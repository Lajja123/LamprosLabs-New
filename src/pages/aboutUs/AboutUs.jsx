        ...
        <section className="section1-aboutUs py-sm-5 py-3">
          ...
          <Slide bottom duration={2000} distance="50px">
            ...
            <div className="about-sec1-box">
              ...
              <p className="aboutUs-section1-card-desc">
                Through the Lampros Labs Collective, we’re championing a unique
                movement. A movement where public goods take center stage, where
                developers receive unparalleled support, and where blockchain
                technology finds its rightful place in mainstream use.
              </p>
              <p className="aboutUs-section1-card-desc">
                Join us in this monumental journey as we reshape the contours of
                the digital realm, making Web3 more accessible, inclusive, and
                influential.
              </p>
            </div>
            </Slide>
          ...
          <div className="about-sec3-flex1">
            ...
            <div className="sec3-about-blockflex">
              ...
              <p className="sec3-about-pera">
                Lampros Labs stands at the frontier of innovation. Our mission?
                To propel all projects harnessing blockchain technology to
                mainstream consciousness. When we talk about blockchain, we're
                talking about the future, and we're here to lead the charge.
              </p>
            </div>
          </div>
        </Slide>
          ...
          <div className="about-img-flex py-2">
            ...
            <Slide bottom duration={2000} distance="50px">
              <div className="about-sec3-flex2 py-2">
                ...
                <div className="sec3-about-blockflex">
                  <div className="sec3-about-heading">Opportunities Await</div>
                  <p className="sec3-about-pera">
                    We're constantly on the lookout. Each day, established
                    blockchains present new chances to contribute, and we ensure
                    we're first in line to seize them.
                  </p>
                </div>
              </div>
            </Slide>
            ...
            <Slide bottom duration={2000} distance="50px">
              <div className="about-sec3-flex3 py-5">
                ...
                <div className="sec3-about-blockflex">
                  ...
                  <p className="sec3-about-pera">
                    In our pursuit of advancing the blockchain community, we're
                    dedicated to offering public goods. Together, we'll build
                    bridges and fill gaps, ensuring a flourishing ecosystem.
                  </p>
                </div>
              </div>
            </Slide>
            ...
            <Slide bottom duration={2000} distance="50px">
              <div className="about-sec3-flex4 py-3">
                ...
                <div className="sec3-about-blockflex">
                  ...
                  <p className="sec3-about-pera">
                    Novel ideas need nurturing. Lampros Labs recognizes this and
                    is committed to pooling the necessary resources, ensuring
                    groundbreaking projects aren't just dreams, but tangible
                    realities.
                  </p>
                </div>
              </div>
          ...
          <div className="d-flex d-lg-inline">
            ...
            <Slide bottom duration={2000} distance="50px">
              <div className="about-box-sec4">
                ...
                <div className="about-sec4-box-pera">
                  Broaden your horizons. Our sessions offer both global exposure
